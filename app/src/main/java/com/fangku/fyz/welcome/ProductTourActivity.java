package com.fangku.fyz.welcome;
...
public class ProductTourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageView = ImageView.class.cast(findViewById(R.id.iv_welcome_view));
        ...
        pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == NUM_PAGES - 2) {
                    ...
                    done.startAnimation(CommonUtil.show_in_bottom());
    ...
    private void buildCircles() {
        ...
        for (int i = 0; i < NUM_PAGES - 1; i++) {
            ...
            circle.setImageResource(R.mipmap.start_swipe_indicator_white_18dp);
    ...
    private void setIndicator(int index) {
        if (index < NUM_PAGES) {
            for (int i = 0; i < NUM_PAGES - 1; i++) {
                ...
                if (i == index) {
                    circle.setColorFilter(ContextCompat.getColor(ProductTourActivity.this, R.color.red));
                } else {
